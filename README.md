...
│   ├── utils/               # Утилиты (validation, whatsapp, constants)
...
- ⚡ **Быстрая загрузка** — code splitting с lazy loading секций
...
- 💬 **Интеграция с WhatsApp** — все формы отправляют сообщения в WhatsApp
